"""
https://github.com/EstherBear/small-net-cifar100/blob/master/models/efficientnet.py
"""
import torch
...
class EfficientNet(nn.Module):
    def __init__(self, width_multipler, depth_multipler, do_ratio, min_width=0, width_divisor=8,
        ...
        self.final_feat_dim = renew_width(1280)
        self.linear = nn.Linear(renew_width(1280), num_class)
