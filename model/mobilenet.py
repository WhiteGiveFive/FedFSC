"""
Borrowed from https://github.com/xiaolai-sqlai/mobilenetv3/blob/master/mobilenetv3.py
"""
...
class MobileNetV3_Small_cifar(nn.Module):
    def __init__(self, num_classes=1000, act=nn.Hardswish):
        super(MobileNetV3_Small_cifar, self).__init__()
        ...
        self.final_feat_dim = 1280  # my customised code for FSL
        self.init_params()
    ...
    def forward(self, x):
        f = self.hs1(self.bn1(self.conv1(x)))
        f = self.bneck(f)

        f = self.hs2(self.bn2(self.conv2(f)))
...
class MobileNetV3_Small_gsc(nn.Module):
    def __init__(self, num_classes=1000, act=nn.Hardswish):
        super(MobileNetV3_Small_gsc, self).__init__()
        ...
        self.final_feat_dim = 576  # my customised code for FSL
        self.init_params()
